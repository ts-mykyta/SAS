...
const country = computed(() => {
  // поддержим как явный d.slug в JSON, так и вычисление из country
                            ...
                            >
                              ...
                              >
                                <div class="overflow-hidden">
                                  ...
                                  >
                                    <div
                                      v-for="(loc, i) in (country.popularLocations || []).slice(
                                        0,
                                        3,
                                      )"
                                      :key="`slide-` + i"
                                    ...
                                    >
                                      <div class="h-64 md:h-80 relative">
                                        <img
                                          ...
                                          decoding="async"
                                          class="w-full h-full object-cover"
                                          :alt="country.title || country.country"
                                          :src="country.sliderImg || country.img"
                                        />
                                      </div>
                                    </div>
                                  </div>
                                  ...
                                  >
                                    <div class="flex flex-col md:flex-row">
                                      ...
                                      <div class="md:w-2/3 p-5 flex flex-col">
                                        ...
                                        <p class="text-muted-foreground mb-4 flex-grow">
                                          Odkryj bogate smaki i kulinarne tradycje swojego miejsca
                                          docelowego, próbując różnorodnych lokalnych potraw,
                                          przekąsek i napojów. Prowadzeni przez kompetentnych
                                          gospodarzy odkryjesz ukryte perełki, poznasz regionalne
                                          składniki i zanurzysz się w kulturze poprzez jedzenie.
                                        </p>
                                        <div
                                          class="flex items-center justify-center text-sm text-gray-500 dark:text-gray-400 mb-4"
                                        >
                                  ...
                                  >
                                    <div class="flex flex-col md:flex-row">
                                      ...
                                      <div class="md:w-2/3 p-5 flex flex-col">
                                        ...
                                        <p class="text-muted-foreground mb-4 flex-grow">
                                          Rozkoszuj się odmładzającą ucieczką z Spa Day, gdzie
                                          doświadczeni terapeuci, kojące zabiegi, i spokojne
                                          otoczenie przywracają twój umysł, ciało, i ducha.
                                          Zrelaksuj się w basenach z gorącymi kamieniami, oddaj się
                                          aromatycznym masażom, i zanurz się w całkowitym relaksie
                                          dla spokojnego i odświeżającego doświadczenia.
                                        </p>
                                        <div
                                          class="flex items-center justify-center text-sm text-gray-500 dark:text-gray-400 mb-4"
                                        >
                                  ...
                                  >
                                    <div class="flex flex-col md:flex-row">
                                      ...
                                      <div class="md:w-2/3 p-5 flex flex-col">
                                        ...
                                        <p class="text-muted-foreground mb-4 flex-grow">
                                          Doświadcz barwnej mozaiki lokalnych tradycji poprzez
                                          urzekające występy, muzykę, taniec i opowiadanie historii
                                          podczas angażującego Pokazu Kulturowego.
                                        </p>
                                        <div
                                          class="flex items-center justify-center text-sm text-gray-500 dark:text-gray-400 mb-4"
                                        >
                                  ...
                                  >
                                    <div class="flex flex-col md:flex-row">
                                      ...
                                      <div class="md:w-2/3 p-5 flex flex-col">
                                        ...
                                        <p class="text-muted-foreground mb-4 flex-grow">
                                          Dołącz do profesjonalnych fotografów na immersyjnym
                                          Warsztacie Fotograficznym, ucząc się zaawansowanych
                                          technik kadrowania dramatycznych krajobrazów, żywych scen
                                          ulicznych, i bogatych momentów kulturowych. Odkrywaj
                                          ukryte perełki, doskonal swoje umiejętności, i wróć do
                                          domu z oszałamiającym portfolio zdjęć z podróży.
                                        </p>
                                        <div
                                          class="flex items-center justify-center text-sm text-gray-500 dark:text-gray-400 mb-4"
                                        >
                            ...
                            >
                              ...
                              <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                                ...
                                >
                                  ...
                                  <p class="text-xs text-muted-foreground">Tokio</p>
                                ...
                                <div
                                  class="bg-card/90 backdrop-blur-sm rounded-lg border border-orange-100 dark:border-orange-900/30 p-3 hover:shadow-md transition-shadow"
                                >
                                  <h4 class="font-semibold text-card-foreground">Narisawa</h4>
                                  <p class="text-xs text-muted-foreground">Tokio</p>
                                  <div class="flex items-center mt-2">
                                    <svg
                                      xmlns="http://www.w3.org/2000/svg"
                                ...
                                <div
                                  class="bg-card/90 backdrop-blur-sm rounded-lg border border-orange-100 dark:border-orange-900/30 p-3 hover:shadow-md transition-shadow"
                                >
                                  <h4 class="font-semibold text-card-foreground">Ichiran Ramen</h4>
                                  <p class="text-xs text-muted-foreground">Fukuoka</p>
                                  <div class="flex items-center mt-2">
                                    <svg
                                      xmlns="http://www.w3.org/2000/svg"
                                      width="24"
                                ...
                                <div
                                  class="bg-card/90 backdrop-blur-sm rounded-lg border border-orange-100 dark:border-orange-900/30 p-3 hover:shadow-md transition-shadow"
                                >
                                  <h4 class="font-semibold text-card-foreground">Kikunoi</h4>
                                  <p class="text-xs text-muted-foreground">Kioto</p>
                                  <div class="flex items-center mt-2">
                                    <svg
                                      xmlns="http://www.w3.org/2000/svg"
                                      width="24"
                                ...
                                <div
                                  class="bg-card/90 backdrop-blur-sm rounded-lg border border-orange-100 dark:border-orange-900/30 p-3 hover:shadow-md transition-shadow"
                                >
                                  <h4 class="font-semibold text-card-foreground">Ishikawa</h4>
                                  <p class="text-xs text-muted-foreground">Tokio</p>
                                  <div class="flex items-center mt-2">
                                    <svg
                                      xmlns="http://www.w3.org/2000/svg"
                                ...
                                <div
                                  class="bg-card/90 backdrop-blur-sm rounded-lg border border-orange-100 dark:border-orange-900/30 p-3 hover:shadow-md transition-shadow"
                                >
                                  <h4 class="font-semibold text-card-foreground">Gion Karyo</h4>
                                  <p class="text-xs text-muted-foreground">Kioto</p>
                                  <div class="flex items-center mt-2">
                                    <svg
                                      xmlns="http://www.w3.org/2000/svg"
                              ...
                              <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                >
                                  ...
                                  <p class="text-muted-foreground">
                                    Remember to bow as a greeting and show respect in temples and
                                    shops
                                  </p>
                                </div>
                                <div
                                ...
                                >
                                  ...
                                  <p class="text-muted-foreground">
                                    Remove your shoes when entering homes, ryokans, and some
                                    restaurants
                                  </p>
                                </div>
                                <div
                                ...
                                >
                                  ...
                                  <p class="text-muted-foreground">
                                    Carry small gifts or omiyage when visiting friends or returning
                                    home
                                  </p>
                                </div>
                                <div
                                ...
                                >
                                  ...
                                  <p class="text-muted-foreground">
                                    Follow proper temple etiquette: cleanse at the chozuya and
