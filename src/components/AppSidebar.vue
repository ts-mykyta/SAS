...
<template>
  <nav class="hidden lg:block w-64 max-w-64 h-screen fixed left-0 top-0 bg-background shadow-lg z-50 overflow-y-auto transform transition-transform duration-300 ease-in-out border-r border-border sidebar-border">
    <nav class="w-full h-full bg-background overflow-y-auto border-r border-border sidebar-border">
      <div class="p-3 lg:p-4">
        ...
        <div class="space-y-1 mb-4">
          <h3 class="text-xs font-semibold text-muted-foreground uppercase tracking-wider px-3 mb-2">Szybkie Linki</h3>
          <a href="/pl-PL/about" data-discover="true">
            <button class="inline-flex items-center gap-2 whitespace-nowrap rounded-md ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&amp;_svg]:pointer-events-none [&amp;_svg]:size-4 [&amp;_svg]:shrink-0 hover:bg-accent py-2 w-full justify-start font-medium transition-all duration-200 relative text-sm h-8 px-3 text-muted-foreground hover:text-foreground">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-compass h-3.5 w-3.5 mr-2" aria-hidden="true">
          ...
          <a href="/pl-PL/contact" data-discover="true">
            <button class="inline-flex items-center gap-2 whitespace-nowrap rounded-md ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&amp;_svg]:pointer-events-none [&amp;_svg]:size-4 [&amp;_svg]:shrink-0 hover:bg-accent py-2 w-full justify-start font-medium transition-all duration-200 relative text-sm h-8 px-3 text-muted-foreground hover:text-foreground">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-mail h-3.5 w-3.5 mr-2" aria-hidden="true">
                <path d="m22 7-8.991 5.727a2 2 0 0 1-2.009 0L2 7"></path>
                <rect x="2" y="4" width="20" height="16" rx="2"></rect>
              </svg>
              Kontakt
