      ...
      <div class="p-6 flex-1 flex flex-col">
        <div class="mb-3">
          <div class="flex justify-between items-start mb-2">
            <h4 class="text-xl font-bold text-card-foreground">{{ props?.title }}</h4>
          ...
          <div class="flex flex-wrap items-center text-muted-foreground text-sm mb-1">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
              ...
              stroke-linecap="round"
              stroke-linejoin="round"
              class="lucide lucide-map-pin h-4 w-4 mr-1 shrink-0"
              aria-hidden="true"
            >
              <path
            ...
            ><span>Włochy</span> -->
            <span>{{ props.countries.join(' • ') }}</span>
          </div>
        </div>
          ...
          <div class="flex justify-between items-center">
            <span class="text-primary font-medium flex items-center">
              ...
              <svg
                ...
                stroke-linecap="round"
                stroke-linejoin="round"
                class="lucide lucide-arrow-right w-5 h-5 ml-1"
                aria-hidden="true"
              >
